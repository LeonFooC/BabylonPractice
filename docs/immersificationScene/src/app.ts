...
import { Engine, Scene, ArcRotateCamera, Vector3, HemisphericLight, Mesh, MeshBuilder, FreeCamera, Color4, UniversalCamera, StandardMaterial, Color3, Matrix, Quaternion, PointLight, ShadowGenerator, WebXRCamera, WebXRSessionManager } from "@babylonjs/core";
...
class App
{
    ...
    constructor() {
        ...
        var camera = new UniversalCamera("UniversalCamera", new Vector3(0, 5, -10), this._scene);
        ...
        var ground = MeshBuilder.CreateGround("ground", { width: 80, height: 80 }, this._scene);
